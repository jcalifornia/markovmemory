...
\title[Memory determination in finite-state random walks]{A critical look at the hot hands fallacy using  predictive memory selection for multistep Markov Chains}
...
\caption{\textbf{LeBron James' free throw accuracy for the 2016-2017 season} and evaluation of the hot hands phenomenon. Observed free throw accuracy as a function of outcome of previous free throw in game show on left. Selection of memory degree $h$ shown on the right.}
