...
A simple real-world application of this method is the evaluation of ``hot-hand phenomenon'' in the context of basketball.   In the 2017 NBA playoffs, the Cleveland Cavaliers played a total of 18 games. In these games, LeBron James attempted $96$ three pointers, making $42$ of them ($44\%$). Taking the outcome of each shot as a state in the set $\{$made, missed$\}$, and the shots in each game as a trajectory, we evaluated memory effects in James' three-point shooting.
