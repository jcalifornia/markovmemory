...
\title[Memory determination in finite-state random walks]{A critical look at the hot hands fallacy using Bayesian predictive memory selection for multistep Markov Chains}
