...
Hence, simply modeling free throw outcome as conditional on past outcome (via multistep Markov chains) is reasonable.

In this paper, we address the general problem of model selection for higher-order Markov chains.
