...
\title{Predictive model selection of multistep Markov chains demonstrated as a method for evaluating hot hands in free throw shooting}
...
Write about the utility of this model and the use of it in basketball
